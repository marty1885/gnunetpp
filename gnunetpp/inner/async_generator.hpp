#pragma once
// Copyright (c) Lewis Baker from the cppcoro project. Licenced under MIT license.
// Copyright (c) 2023 Martin Chang. This file is also MIT. But used in a AGPL project
