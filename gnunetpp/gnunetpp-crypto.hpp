...
GNUNETPP_OPERATOR_COMPOARE_RAW_DATA(GNUNET_CRYPTO_EddsaSignature)
GNUNETPP_OPERATOR_COMPOARE_RAW_DATA(GNUNET_CRYPTO_EcdsaSignature)
...
GNUNETPP_RAW_DATA_HASH(GNUNET_CRYPTO_EddsaSignature)
GNUNETPP_RAW_DATA_HASH(GNUNET_CRYPTO_EcdsaSignature)
